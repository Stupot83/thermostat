(function() {
  ...
  describe("Thermostat", () => {
    ...
    describe("it can be reset to the default temperature", () => {
      it("has an attribute of default_temp", () => {
        expect(typeof thermostat.default_temp).toEqual("number");
      });

      it("is equal to 20 when initialised", () => {
